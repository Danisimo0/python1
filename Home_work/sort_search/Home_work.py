...
# если не сложно, можете пожалуйста написать коменнтарий, в чем была ошибка, как я понял, что много примеров было из
# старого пайтона и много кода уже не работает, по типу "decode" 
