...
class Ui_MainWindow(object):
    ...
    def look1(self, idd=0):
        ...
        if len(self.data) >= 1:
            ...
            self.delete_task_1.setText(_translate("MainWindow", "Delete"))
            self.complate_task_1.setText(_translate("MainWindow", "Run"))
    ...
    def look2(self, idd=1):
        ...
        if len(self.data) >= 2:
            ...
            self.delete_task_2.setText(_translate("MainWindow", "Delete"))
            self.complate_task_2.setText(_translate("MainWindow", "Run"))
    ...
    def look3(self, idd=2):
        ...
        if len(self.data) >= 3:
            ...
            self.delete_task_3.setText(_translate("MainWindow", "Delete"))
            self.complate_task_3.setText(_translate("MainWindow", "Run"))
    ...
    def look4(self, idd=3):
        ...
        if len(self.data) >= 4:
            ...
            self.delete_task_4.setText(_translate("MainWindow", "Delete"))
            self.complate_task_4.setText(_translate("MainWindow", "Run"))
    ...
    def look5(self, idd=4):
        ...
        if len(self.data) >= 5:
            ...
            self.delete_task_5.setText(_translate("MainWindow", "Delete"))
            self.complate_task_5.setText(_translate("MainWindow", "Run"))
    ...
    # def delete_and_look(self, value=None):
    #     self.select_tasks()
    #     try:
